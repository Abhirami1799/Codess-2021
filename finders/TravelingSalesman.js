function TravelingSalesman(options)
{
    options = options || {};
...
TravelingSalesman.prototype.pathFinder = function(startX, startY, endX, endY, grid, lines)
{
    ...
    */
    ...
    console.log("Route Taken"+routeNew);

    for(i = 0; i < routeNew.length; i++)
    {
        //console.log("CURRENT EDGE-"+routeNew[i]);
